                        ...
                        <div className="col-lg-12 pt-4 pt-lg-0 content" data-aos="fade-left">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <ul>
                                        <li><i className="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>1 January 1997</span></li>
                                        <li><i className="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.hasibulhasan.web.app</span></li>
                                        <li><i className="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>(+880) 1311210119</span></li>
                                ...
                                <div className="col-lg-6">
                                    <ul>
                                        ...
                                        <li><i className="bi bi-chevron-right"></i> <strong>Email:</strong> <span>hasibulhasan442@gmail.com</span></li>
